...
IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES )
		DROP TABLE  tbl_BORROWER tbl_BOOK_LOANS tbl_LIBRARY_BRANCH,tbl_BOOKS, tbl_BOOK_AUTHORS, tbl_BOOK_COPIES, tbl_BOOK_LOANS, tbl_BORROWER, tbl_PUBLISHER;
...
(51, 1, 152, '5/11/2019', '5/23/2019'),
(17, 3, 152, '5/3/2019', '5/10/2019'),
(21, 3, 162, '4/25/2019', '5/23/2019'),
...
(NULL, 1, 136, '4/22/2019', '4/27/2019'),
(NULL, 2, 139, '4/24/2019', '4/29/2019')
;
/**********************************
Table for borrowers
***********************************/
...
(139, 'Dwight Smith', '15267, SW 242nd AVE', '215-523-8965')
;
...
WHERE bf.BranchName = 'Sharpstown' AND ld.DateDue = '5/23/2019'

/*************************************
query 5
*****************************************/

SELECT bd.BranchName, COUNT(bc.BookID) AS 'Books loaned Out'
FROM tbl_BOOK_LOANS bc
INNER JOIN tbl_LIBRARY_BRANCH bd ON bc.BranchID = bd.BranchID
GROUP BY bd.BranchName
/******************************************
query 6
******************************************/
SELECT bf.Name, bf.Address, COUNT(bc.CardNo) AS 'Book Copies'
FROM dbo.tbl_BORROWER bf
INNER JOIN dbo.tbl_BOOK_LOANS bc ON bf.CardNo = bc.CardNo
GROUP BY bf.Name, bf.Address 
HAVING COUNT(bc.CardNo)>5	
/*********************************
query 7
**********************************/
