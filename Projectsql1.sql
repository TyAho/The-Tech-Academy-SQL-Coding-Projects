...
*************************/
SELECT * FROM  tbl_LIBRARY_BRANCH, tbl_BOOK_COPIES, tbl_BOOKS
INNER JOIN tbl_BOOK_COPIES a1 ON BranchID = BranchID
WHERE tbl_BOOKS.BookID = 15
;
...
query 5
*****************************************/
SELECT * FROM tbl_LIBRARY_BRANCH, tbl_BOOK_LOANS, tbl_BOOK_COPIES
INNER JOIN tbl_BOOK_LOANS a3 ON tbl_BOOK_COPIES.BookID = tbl_BOOK_COPIES.BookID
...
SELECT * FROM tbl_LIBRARY_BRANCH, tbl_BOOK_LOANS, tbl_BOOK_COPIES
INNER JOIN tbl_BOOK_LOANS a3 ON tbl_BOOK_COPIES.BookID = tbl_BOOK_COPIES.BookID
WHERE tbl_LIBRARY_BRANCH.BranchName = 'Lakeview'

SELECT * FROM tbl_LIBRARY_BRANCH, tbl_BOOK_LOANS, tbl_BOOK_COPIES
INNER JOIN tbl_BOOK_LOANS a3 ON tbl_BOOK_COPIES.BookID = tbl_BOOK_COPIES.BookID
WHERE tbl_LIBRARY_BRANCH.BranchName = 'Southern'
/******************************************
query 6
******************************************/
SELECT * FROM tbl_BORROWER, tbl_BOOK_LOANS, tbl_BOOK_COPIES
INNER JOIN tbl_BORROWER a2 ON CardNo = CardNo
WHERE tbl_BORROWER.CardNo = 123 AND tbl_BOOK_LOANS.CardNo = 152

/*********************************
query 7
**********************************/
SELECT * FROM tbl_LIBRARY_BRANCH,tbl_BOOK_COPIES,  tbl_BOOKS, tbl_BOOK_AUTHORS
INNER JOIN tbl_BOOKS a1 ON tbl_BOOK_AUTHORS.BookID = tbl_BOOK_AUTHORS.BookID
